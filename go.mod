module github.com/aarshkshah1992/ffi-app

go 1.22.1

require github.com/aarshkshah1992/filecoin-ffi v0.0.3

require (
	github.com/aarshkshah1992/prebuilt-ffi-darwin-arm64 v0.0.2 // indirect
